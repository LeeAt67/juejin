...
function detectAndCollectClues(question, response) {
    ...
    const cluePatterns = [
        ...
        {
            triggers: ['死因', '怎么死', '毒物', '下毒', '投毒'],
            clue: '🔍 死因：疑似中毒，现场发现可疑物质'
        },
        {
            triggers: ['咖啡', '拿铁', '特制'],
            clue: '🔍 现场物证：一杯喝了一半的特制拿铁咖啡'
        },
        {
        ...
        {
            triggers: ['艾米丽', '老板', '陈'],
            clue: '👤 艾米丽·陈：35岁咖啡馆老板，面临经营压力'
        },
        {
            triggers: ['马克', '编辑', '汤普森'],
            clue: '👤 马克·汤普森：40岁出版社编辑，公司财务困难'
        },
        {
            triggers: ['瑞秋', '律师', '前妻', '格林'],
            clue: '👤 瑞秋·格林：38岁律师，处理比尔前妻的财产事务'
        },
        {
            triggers: ['杰克', '演员', '布朗'],
            clue: '👤 杰克·布朗：28岁年轻演员，与比尔存在创作纠纷'
        },
        {
            triggers: ['萨拉', '书迷', '粉丝', '戴维斯'],
            clue: '👤 萨拉·戴维斯：30岁忠实书迷，经常参加读者活动'
        },
        {
            triggers: ['汤姆', '服务员', '威尔逊'],
            clue: '👤 汤姆·威尔逊：22岁医学院学生，在咖啡馆兼职'
        }
    ];
